            ...
            <div className='container'>
                <div className='flex items-center'>
                      ...
                      <ul className='flex flex-wrap items-center gap-6'>
                        ...
                        className='download_tech-link download_tech-link_last-before download_tech-link_last-after'>
                            ...
                            className='size-22 download_tech-icon_before relative flex items-center justify-center
                             rounded-half border-2 border-s3 bg-s1 transition-borderColor duration-500'>
                                ...
                                />
                                <span className='download_tech-icon'>{icon}
                    ...
                    <div className='mb-10 max-md:hidden'>
                        <div className='dwonload_preview-before download_preview-after rounded-40
